...
class ProgressingTableView : UIViewController {
...
extension ProgressingTableView : UITableViewDelegate, UITableViewDataSource, UIScrollViewDelegate{
    func setTableview() {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.commentLabel.text = "게시종료일 : " + post.noti
        cell.dangerView.text = "제안자 : " + "\(post.proposer)"
    ...
    func showPostDetail(post: Post){
        let detailViewController = ProgressingDetailViewController(post: post)
                    ...
                    for item in row {
                        if let billName = item["BILL_NAME"] as? String,
                           ...
                           let proporser_cd = item["PROPOSER_KIND_CD"] as? String{
                            let post = Post(bill_name: billName, proposer_cd: proporser_cd, proposer: proposer, committee: committee, bill_no: billNo, noti: noti)
                            posts.append(post)
                        }
                    }
