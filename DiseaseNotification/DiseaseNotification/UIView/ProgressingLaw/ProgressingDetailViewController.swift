...
class ProgressingDetailViewController : UIViewController {
    let post : Post
    ...
    func setupViews() {
        ...
        hospitalBtn.addTarget(self, action: #selector(progressingBtnTapped), for: .touchUpInside)
    ...
    @objc func progressingBtnTapped() {
